...
import digitalmarketing from "../assets/marketing-2.mp4";
  ...
  return (
    <>
      <div className="flex md:justify-around justify-center flex-wrap lg:flex-nowrap lg:pt-32 pt-10 pb-5 px-2 gap-3">
        ...
        >
          <source src={digitalmarketing} type="video/mp4" />
        </video>
...
export default MarketingAssociate;
